...
- **`:metabind`** — Core library. Apollo GraphQL client, repository, ViewModels, and Composable entry points. Published as `ai.metabind:metabind-android`.
...
Schema files in `metabind/src/main/graphql/`:
