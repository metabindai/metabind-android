...
```kotlin
dependencies {
    implementation("ai.metabind:metabindai-android:0.2.2")        // embed the agent
    implementation("ai.metabind:mcpappshost-android:0.2.2")       // low-level rendering
    implementation("ai.metabind:metabind-content-android:0.2.2")  // content SDK
}
```
